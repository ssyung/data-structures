...
var particle_variable = 'jsonString';
...
var getAndWriteData = function() {
    ...
    request(device_url, function(error, response, body) {
        ...
        var photo = JSON.parse(device_json_string).photovalue;
        var tempC = JSON.parse(device_json_string).tempvalue;
        ...
        var thisQuery = "INSERT INTO fridge_readings VALUES (" + photo + "," + tempC + ", DEFAULT);";
